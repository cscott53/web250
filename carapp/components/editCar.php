...
<br><form>
    ...
    <script>
        ...
        document.getElementById('update').onclick=e=>{
            ...
            location.href=`?vin=${vin}&make=${make}&model=${model}&price=${price}&year=${year}&trim=${trim}&color=${color}&interior=${interior}&mileage=${mileage}&transmission=${transmission}&pg=editCar`
        }
    </script>
</form>